...
\subsection{Protein-ligand docking: benchmark against diverse datasets}
...
\subsection{Covalently restrained docking of several ligands at once}
...
\section{Metal ions: Organization \& binding site prediction}

\todo[inline]{Something about we have dealt impliticly with metals until now, but how we can do it explicitly with adequate objectives.}

\subsection{Studying backbone flexibility for peptide folding}
...
\subsection{Small compound folding: Zn-bound siderophores}
...
\begin{table}[hbtp]
	...
	\begin{tabularx}{\textwidth}{RL}
		...
		\toprule
		%row no:4
		\tableheading{Objectives (evaluation)}\\
		\toprule
		%row no:5
